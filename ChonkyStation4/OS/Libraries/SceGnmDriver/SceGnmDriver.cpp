...
void init(Module& module) {
    ...
    module.addSymbolForPartialLLE("QhnyReteJ1M", "sceGnmDrawInitDefaultHardwareState175", "libSceGnmDriver", "libSceGnmDriver");
    ...
    module.addSymbolForPartialLLE("5uFKckiJYRM", "sceGnmSetPsShader350", "libSceGnmDriver", "libSceGnmDriver");
    module.addSymbolForPartialLLE("4MgRw-bVNQU", "sceGnmUpdatePsShader", "libSceGnmDriver", "libSceGnmDriver");
